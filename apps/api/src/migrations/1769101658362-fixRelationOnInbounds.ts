...
export class FixRelationOnInbounds1769101658362 implements MigrationInterface {
    name = 'FixRelationOnInbounds1769101658362'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "inbound_items" ("id_inbound_item" uuid NOT NULL DEFAULT uuid_generate_v4(), "id_inbound" uuid NOT NULL, "id_item" uuid NOT NULL, "qty_received" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "id_poi" uuid, CONSTRAINT "PK_fa48753237d04b2b178d75c5d92" PRIMARY KEY ("id_inbound_item"))`);
